  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: 'بانر الإسعافات',
        description: 'صفحة الإسعافات الأولية.',
        tone: 'bg-red-50 text-red-700',
        icon: '🩹',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: 'بانر الصحة والجمال',
        description: 'إدارة بانر قسم الصحة والجمال.',
        tone: 'bg-pink-50 text-pink-600',
        icon: '💄',
      },
      {
        href: '/admin/mental-health-banner',
        label: 'بانر الصحة النفسية',
        description: 'إدارة بانر قسم الصحة النفسية.',
        tone: 'bg-blue-50 text-blue-600',
        icon: '🧠',
      },
      {
        href: '/admin/sexual-health-banner',
        label: 'بانر الصحة الجنسية',
        description: 'إدارة بانر قسم الصحة الجنسية.',
        tone: 'bg-rose-50 text-rose-600',
        icon: '❤️',
      },
      {
        href: '/admin/fitness-health-banner',
        label: 'بانر اللياقة البدنية',
        description: 'إدارة بانر قسم اللياقة البدنية.',
