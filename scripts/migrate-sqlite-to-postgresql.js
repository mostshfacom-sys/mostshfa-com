    ...
    for (const hospital of hospitals) {
      await prisma.hospital.upsert({
        ...
        create: {
          ...
          metadata: JSON.stringify(hospital.metadata || {}),
          workingHours: JSON.stringify(hospital.working_hours || {}),
          services: JSON.stringify(hospital.services || []),
          insuranceAccepted: JSON.stringify(hospital.insurance_accepted || []),
          emergencyServices: JSON.stringify(hospital.emergency_services || {}),
          parkingAvailable: false,
          wheelchairAccessible: false,
          languagesSpoken: JSON.stringify(hospital.languages_spoken || []),
          isVerified: false,
